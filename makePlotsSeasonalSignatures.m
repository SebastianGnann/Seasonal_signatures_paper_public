...
rng(2019) % shuffle plotting order
shuffle_UK = randperm(length(A_vec_UK))';
plotSeasonalSignaturesData(A_vec_UK(shuffle_UK),phi_vec_UK(shuffle_UK),w_1y,...
    'attribute',seasonal_signatures_UK.I_m(shuffle_UK),'attribute_name','I_m',...
    'ID',ID_UK(shuffle_UK),... 
    'A_confInt',A_vec_confInt_UK(shuffle_UK),'phi_confInt',phi_vec_confInt_UK(shuffle_UK),...
    'x_limits',[0 1.2],'y_limits',[0 140],...
...
% climate and catchment attributes
shuffle_CAMELS = randperm(length(A_vec_CAMELS))';
plotSeasonalSignaturesData(A_vec_CAMELS(shuffle_CAMELS),phi_vec_CAMELS(shuffle_CAMELS),w_1y,...
    'attribute',seasonal_signatures_CAMELS.I_m(shuffle_CAMELS),'attribute_name','I_m',...
    'ID',ID_CAMELS(shuffle_CAMELS),... 
    'A_confInt',A_vec_confInt_CAMELS(shuffle_CAMELS),'phi_confInt',phi_vec_confInt_CAMELS(shuffle_CAMELS),...
